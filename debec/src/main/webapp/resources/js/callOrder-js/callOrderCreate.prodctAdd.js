$(document).ready(function() {	
	...
	$.ajax({
		...
		$('#tree').on("changed.jstree", function (e, data) {
			...
			$.ajax({
				type: "GET",
				data : catgrSeq,
				url: "/callOrderProdctAddList.do",
				success:function(msg)
				{
					document.getElementById("prodctAdList").innerHTML = msg;
				},
	...
	if(chked_length == 0){
		...
		$.ajax({
			type:"POST",
			url:"/callOrderProdctAdTempCreate.do",
			data:chked_val,
			success:function(){
				$.ajax({
					type: "POST",
				...
				$.ajax({
					type: "POST",
					url: '/callOrderProdctAdTempList.do',
					success: function(msg) {
	...
	if(chked_length == 0){
		...
		$.ajax({
			type:"POST",
			url:"/callOrderProdctAddTempDelete.do",
			data:chked_val,
			success:function(){
				$.ajax({
					type: "POST",
